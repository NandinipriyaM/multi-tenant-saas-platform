      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-4 mb-6 flex gap-4 flex-wrap">
          ...
          >
            ...
            {/* Added explicit filter for Super Admin */}
                ...
                {users.map((u) => (
                  <tr key={u.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      {/* FIXED: Logic to handle all three possible role values */}
                      <span
                    ...
                    <td className="px-6 py-4">
                      {/* Actions restricted to specific roles or conditions */}
        ...
        {/* Modal for adding users - only for Tenant Admin */}
